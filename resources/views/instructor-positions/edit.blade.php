<x-app-layout>
    ...
    <div class="dashboard-header">
        <div class="dashboard-title">Edit Instructor Position</div>
        <div class="dashboard-subtitle">Update an existing position assignment</div>
    </div>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="module-card">
            ...
            <form action="{{ route('instructor-positions.update', $instructorPosition->id) }}" method="POST">
                @csrf
                @method('PUT')
