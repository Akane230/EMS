<x-app-layout>
    ...
    <div class="dashboard-header">
        <div class="dashboard-title">Edit Program</div>
        <div class="dashboard-subtitle">Update program information</div>
    </div>
        ...
        <div class="module-card">
            <form action="{{ route('programs.update', $program->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="program_name" name="program_name" class="w-full pl-4 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-2 focus:ring-primary-500 focus:border-primary-500" placeholder="Enter program name" value="{{ old('program_name', $program->program_name) }}" required>
                    @error('program_name')
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('programs.show', $program->id) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                        Cancel
                    </a>
