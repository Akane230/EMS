<x-app-layout>
    ...
    <div class="dashboard-header">
        ...
        <div class="dashboard-subtitle">Update information for {{ $department->department_name }}</div>
    </div>
    ...
    <div class="module-card">
        <form action="{{ route('departments.update', $department) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="department_name" name="department_name" value="{{ old('department_name', $department->department_name) }}" 
