    ...
    <div class="module-card">
        <div class="mb-6">
            ...
            <div class="mt-8 flex items-center space-x-4">
                <a href="{{ route('departments.edit', $department) }}" class="module-action">
                ...
                <form action="{{ route('departments.destroy', $department) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="py-2 px-4 bg-red-600 hover:bg-red-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2" onclick="return confirm('Are you sure you want to delete this department?')">
