    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-md p-6 mb-6 text-white">
                <h1 class="text-2xl font-bold mb-2 black-text">Welcome back, {{ Auth::user()->name }}!</h1>
                <p class="opacity-90 black-text">Here's what's happening with your academics today</p>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-center">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('studentSide.enrollment.create') }}" class=" black-text inline-flex items-center px-4 py-2 border border-transparent text-black text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    Enroll Now
                                </a>
                            </div>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                    <div class="p-6">
                        <div class="text-center">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('studentSide.enrollment.download.cor') }}" class=" black-text inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    <i class="fas fa-download mr-2 black-text"></i> Download COR
                                </a>
                            </div>
                        </div>
                    </div>
