                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-4 mt-2">
                                    ...
                                    <div class="flex-1 space-y-2">
                                        ...
                                        <!-- Remove Avatar Checkbox (only show if avatar exists) -->
                                        @if(auth()->user()->avatar)
                                            <div class="flex items-center">
                                                <input id="remove_avatar" name="remove_avatar" type="checkbox" 
                                                    value="1" {{ old('remove_avatar') ? 'checked' : '' }}
                                ...
                                <div>
                                    <p class="text-sm mt-2 text-gray-800 dark:text-gray-200">
                                        ...
                                        <button form="send-verification" 
                                            class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
